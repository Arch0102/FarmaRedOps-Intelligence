...
public class MovimientoInventarioController {
    ...
    public ResponseEntity<ApiResponse<MovimientoInventarioResponse>> registrarMovimiento(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(HttpStatus.CREATED, "Movimiento registrado correctamente", servletRequest.getRequestURI(), response));
    }
    ...
    public ResponseEntity<ApiResponse<MovimientoInventarioResponse>> consultarPorId(
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK, "Movimiento consultado correctamente", request.getRequestURI(), response));
    }
    ...
    public ResponseEntity<ApiResponse<List<MovimientoInventarioResponse>>> consultarKardexPorInventario(
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK, "Kardex consultado correctamente", request.getRequestURI(), response));
    }
}
